    ...
    <div className=" w-full rounded-b-3xl shadow">
      ...
      <div className="rounded-b-3xl bg-white overflow-hidden ">
        <div className="flex items-center justify-between px-8 py-6 border-b border-[#D6D6D8]">
          ...
          <p className=" text-4xl font-bold">{nairaCurrencyFormatter(order.remainingAmount || 0)}</p>
        </div>
        <div className="flex justify-center py-6 ">
          <button onClick={() => openModal("agent-accept-order", order.id)} className="px-14 py-2 rounded-lg bg-cash-get-dark-400 text-white">
            View
          </button>
        </div>
      </div>
